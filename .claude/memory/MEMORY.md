...
- [mouserat_trade-bud](mouserat-trade-bud.md) — trade-diagnostic subproject; v1 (3 slices) built, pending browser verification; Round 2 approved 2026-07-18 (pointer: `~/.claude/plans/critically-review-our-graceful-nebula.md`), Phase 0 (data-model Mermaid sync + `00_fantasy_etl_flow` orchestrator) DONE, Phase A next
